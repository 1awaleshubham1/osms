...
if(isset($_REQUEST['empsubmit']))
{
    ...
    else
    {
        ...
        values('$ename', '$ecity', '$emobile', '$email')";
        ...
        {
            $msg = '<div class="alert alert-info col-sm-6 ml-5 mt-2" role="alert">Unable to added data</div>'.mysqli_error($conn);
        }
    }
}
?>
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="empMobile" name="empMobile" onkeypress="isInputNumber(event)">
        </div>  
        <div class="form-group">
